  ...
  <div className={'hackathon ' + (isTeaser ? 'hackathon-teaser' : '')}>
    <Container>
      ...
      {isTeaser && <>
        ...
        <p className="hackathon-text">What can you make in {total} hours? Bring your laptop and some snacks and join us in the attic at <a href={locationUrl} target="_blank">{location}</a>.</p>
      </>}
